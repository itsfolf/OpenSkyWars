...
public class ResetBlock implements Serializable {
    ...
    private HashMap<Integer, ArrayList<Integer>> enchbook_id = new HashMap<Integer, ArrayList<Integer>>();
    ...
    public ResetBlock(Block b, boolean c, boolean s) {
        m = b.getType();
        x = b.getX();
        y = b.getY();
        z = b.getZ();
    ...
    public ResetBlock(Location l, Material m, byte data) {
        this.m = m;
        x = l.getBlockX();
        y = l.getBlockY();
        z = l.getBlockZ();
    ...
    public void setInventory(Inventory inventory) {
        ...
        item_mats = new ArrayList<>();
        item_data = new ArrayList<>();
        item_amounts = new ArrayList<>();
        item_displaynames = new ArrayList<>();
        item_splash = new ArrayList<>();
        item_pos = new ArrayList<>();
        item_enchid = new HashMap<>();
        item_enchid_lv = new HashMap<>();
        enchbook_id_lv = new HashMap<>();
        item_durability = new ArrayList<>();
